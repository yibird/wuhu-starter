...
public class CollectionUtils {
     ...
     * @return 返回转换后的List
     */
    public static <T, E> List<E> toList(Collection<T> collection, Function<T, E> func) {
        if (collection == null || collection.isEmpty() || func == null) {
            return List.of();
        }
     ...
     * @return 返回转换后的Set
     */
    public static <T, E> Set<E> toset(Collection<T> collection, Function<T, E> func) {
        if (collection == null || collection.isEmpty() || func == null) {
            return Set.of();
        }
