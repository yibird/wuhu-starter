...
import io.github.yibird.starter.filter.TLogServletFilter;
import io.github.yibird.starter.handler.TraceIdGenerator;
...
public class TraceAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[{}] - Auto Configuration 'Trace' completed initialization.", PropertiesConstants.STARTER_NAME_UPPER);
    }
}
